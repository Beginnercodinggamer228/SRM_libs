...
namespace MonoMod.Utils
{
	...
	internal class RelinkFailedException : Exception
	{
		...
		public RelinkFailedException(IMetadataTokenProvider mtp, IMetadataTokenProvider context = null) : this(RelinkFailedException._Format("MonoMod failed relinking", mtp, context), mtp, context)
		{
		}

		// Token: 0x060017B1 RID: 6065 RVA: 0x00052EDA File Offset: 0x000510DA
		public RelinkFailedException(string message, IMetadataTokenProvider mtp, IMetadataTokenProvider context = null) : base(message)
		{
			this.MTP = mtp;
		...
		public RelinkFailedException(string message, Exception innerException, IMetadataTokenProvider mtp, IMetadataTokenProvider context = null) : base(message ?? RelinkFailedException._Format("MonoMod failed relinking", mtp, context), innerException)
		{
			this.MTP = mtp;
			this.Context = context;
		}
