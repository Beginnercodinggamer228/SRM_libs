...
namespace MonoMod.Utils
{
	...
	{
		// Token: 0x0600169D RID: 5789 RVA: 0x0004A884 File Offset: 0x00048A84
		...
		// Token: 0x0600169E RID: 5790 RVA: 0x0004A924 File Offset: 0x00048B24
		public static MethodBuilder GenerateMethodBuilder(DynamicMethodDefinition dmd, TypeBuilder typeBuilder)
		{
			...
			if (typeBuilder == null)
			{
				...
				else
				{
					...
					arg = ((id != null) ? id.Replace('.', '_') : null);
				}
				typeBuilder = moduleBuilder.DefineType(string.Format(format, arg, dmd.GetHashCode()), System.Reflection.TypeAttributes.Public | System.Reflection.TypeAttributes.Abstract | System.Reflection.TypeAttributes.Sealed);
			}
			Type[] array;
			Type[][] array2;
			Type[][] array3;
