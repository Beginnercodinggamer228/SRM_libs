...
namespace MonoMod.Utils
{
	...
	internal sealed class MMReflectionImporter : IReflectionImporter
	{
		...
		public FieldReference ImportReference(FieldInfo field, IGenericParameterProvider context)
		{
			...
			return this.CachedFields[key] = new FieldReference(field.Name, this._ImportReference(field.FieldType, typeReference, MMReflectionImporter.GenericImportKind.Open), typeReference);
		}
