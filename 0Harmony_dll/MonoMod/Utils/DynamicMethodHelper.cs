	...
	internal static class DynamicMethodHelper
	{
		...
		private static int AddReference(object obj)
		{
			...
			lock (references)
			{
				...
				result = DynamicMethodHelper.References.Count - 1;
			}
			return result;
		}
		...
		private static readonly MethodInfo _GetMethodFromHandle = typeof(MethodBase).GetMethod("GetMethodFromHandle", new Type[]
		{
