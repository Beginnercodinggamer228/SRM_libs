	...
	public class DetourRuntimeNETPlatform : DetourRuntimeILPlatform
	{
		...
		protected override RuntimeMethodHandle GetMethodHandle(MethodBase method)
		{
			...
			if (dynamicMethod != null)
			{
				...
				{
					DetourRuntimeNETPlatform._RuntimeHelpers__CompileMethod.Invoke(null, new object[]
					{
						((RuntimeMethodHandle)DetourRuntimeNETPlatform._DynamicMethod_GetMethodDescriptor.Invoke(dynamicMethod, DetourRuntimeNETPlatform._NoArgs)).Value
					});
				}
				else if (DetourRuntimeNETPlatform._RuntimeHelpers__CompileMethod_TakesIRuntimeMethodInfo)
				{
					DetourRuntimeNETPlatform._RuntimeHelpers__CompileMethod.Invoke(null, new object[]
					{
						DetourRuntimeNETPlatform._RuntimeMethodHandle_m_value.GetValue((RuntimeMethodHandle)DetourRuntimeNETPlatform._DynamicMethod_GetMethodDescriptor.Invoke(dynamicMethod, DetourRuntimeNETPlatform._NoArgs))
					});
				}
				else if (DetourRuntimeNETPlatform._RuntimeHelpers__CompileMethod_TakesRuntimeMethodHandleInternal)
				{
					DetourRuntimeNETPlatform._RuntimeHelpers__CompileMethod.Invoke(null, new object[]
					{
						DetourRuntimeNETPlatform._IRuntimeMethodInfo_get_Value.Invoke(DetourRuntimeNETPlatform._RuntimeMethodHandle_m_value.GetValue((RuntimeMethodHandle)DetourRuntimeNETPlatform._DynamicMethod_GetMethodDescriptor.Invoke(dynamicMethod, DetourRuntimeNETPlatform._NoArgs)), null)
					});
				}
				else
				{
		...
		protected unsafe override IntPtr GetFunctionPointer(MethodBase method, RuntimeMethodHandle handle)
		{
			...
			{
				int num5 = num4 + 11;
				int value = *(IntPtr)(num5 + 1) + (num5 + 1 + 4);
				intPtr = this.NotThePreStub(intPtr, (IntPtr)value);
			...
			{
				int num6 = num4;
				int value2 = *(IntPtr)(num6 + 1) + (num6 + 1 + 4);
				intPtr = this.NotThePreStub(intPtr, (IntPtr)value2);
			...
			Block_22:
			long num7 = num;
			long value3 = (long)(*(UIntPtr)(num7 + 1L)) + (num7 + 1L + 4L);
			intPtr = this.NotThePreStub(intPtr, (IntPtr)value3);
			for (int j = 0; j < 16; j++)
			{
				num = (long)intPtr + (long)j;
				if (*(UIntPtr)num == 47176 && *(UIntPtr)(num + 10L) == 57599)
				{
					value3 = *(UIntPtr)(num + 2L);
					intPtr = this.NotThePreStub(intPtr, (IntPtr)value3);
					j = -1;
				}
				...
				{
					num7 = num;
					value3 = (long)(*(UIntPtr)(num7 + 13L + 2L)) + (num7 + 13L + 2L + 4L);
					intPtr = this.NotThePreStub(intPtr, (IntPtr)value3);
					j = -1;
				}
			}
		...
		private unsafe IntPtr <GetFunctionPointer>g__WalkPrecode|14_0(IntPtr curr)
		{
			...
			{
				IntPtr ptrParsed = *(UIntPtr)(num + 16L);
				return this.NotThePreStub(curr, ptrParsed);
			}
			if (*(UIntPtr)num == 268435595U && *(UIntPtr)(num + 4L) == 2839556458U && *(UIntPtr)(num + 8L) == 3592356160U)
			{
				IntPtr ptrParsed2 = *(UIntPtr)(num + 16L);
				return this.NotThePreStub(curr, ptrParsed2);
			}
			if (*(UIntPtr)num == 268435468U && *(UIntPtr)(num + 4L) == 1476395115U && *(UIntPtr)(num + 8L) == 3592356192U)
			{
				IntPtr ptrParsed3 = *(UIntPtr)(num + 16L);
				return this.NotThePreStub(curr, ptrParsed3);
			}
			...
			{
				IntPtr ptrParsed4 = *(UIntPtr)(num + 24L);
				return this.NotThePreStub(curr, ptrParsed4);
			}
			return curr;
		}
