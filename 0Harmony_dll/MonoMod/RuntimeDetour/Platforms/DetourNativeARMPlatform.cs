...
namespace MonoMod.RuntimeDetour.Platforms
{
	...
	internal class DetourNativeARMPlatform : IDetourNativePlatform
	{
		...
		public NativeDetourData Create(IntPtr from, IntPtr to, byte? type)
		{
			...
			result.Size = DetourNativeARMPlatform.DetourSizes[(int)(result.Type = (type ?? ((byte)DetourNativeARMPlatform.GetDetourType(from, to))))];
			return result;
		}
		...
		public unsafe void FlushICache(IntPtr src, uint size)
		{
			...
			DetourHelper.Native.MakeExecutable((IntPtr)((void*)value), (uint)array.Length);
			(Marshal.GetDelegateForFunctionPointer((IntPtr)((void*)value), typeof(DetourNativeARMPlatform.d_flushicache)) as DetourNativeARMPlatform.d_flushicache)(src, (ulong)size);
			array2 = null;
		}
		...
		private static readonly uint[] DetourSizes = new uint[]
		{
			8U,
			12U,
			8U,
