...
internal static class vp_TargetEventHandler
{
	...
	// (get) Token: 0x06002B99 RID: 11161 RVA: 0x000A3F44 File Offset: 0x000A2144
	...
	// Token: 0x06002B9A RID: 11162 RVA: 0x000A3F88 File Offset: 0x000A2188
	...
	// Token: 0x06002B9B RID: 11163 RVA: 0x000A40C0 File Offset: 0x000A22C0
	...
	// Token: 0x06002B9C RID: 11164 RVA: 0x000A40F0 File Offset: 0x000A22F0
	...
	// Token: 0x06002B9D RID: 11165 RVA: 0x000A411C File Offset: 0x000A231C
		...
		foreach (string text in new List<string>(dictionary2.Keys))
		{
			...
			if (text != null && dictionary2.TryGetValue(text, out @delegate) && @delegate != null)
			{
				...
				if (invocationList != null && invocationList.Length >= 1)
				{
					...
					{
						if (invocationList[i].Target == component)
						{
	...
	// Token: 0x06002B9E RID: 11166 RVA: 0x000A4234 File Offset: 0x000A2434
	...
	// Token: 0x06002B9F RID: 11167 RVA: 0x000A42D7 File Offset: 0x000A24D7
	public static void UnregisterAll()
	{
		vp_TargetEventHandler.m_TargetDict = null;
	}

	// Token: 0x06002BA0 RID: 11168 RVA: 0x000A42E0 File Offset: 0x000A24E0
	...
	// Token: 0x06002BA1 RID: 11169 RVA: 0x000A4394 File Offset: 0x000A2594
	...
	// Token: 0x06002BA2 RID: 11170 RVA: 0x000A43D4 File Offset: 0x000A25D4
	public static string Dump()
	{
		...
		foreach (Dictionary<object, Dictionary<string, Delegate>> dictionary2 in vp_TargetEventHandler.TargetDict)
		{
			foreach (object obj in dictionary2.Keys)
			{
				...
				if (obj != null)
				{
							...
							if (!string.IsNullOrEmpty(text2) && dictionary3.TryGetValue(text2, out @delegate))
							{
								...
								foreach (Delegate delegate2 in @delegate.GetInvocationList())
								{
									text = string.Concat(new object[]
									{
										text,
										flag ? "                        " : "",
										delegate2.Method.ReflectedType,
										".cs -> "
									});
									string text3 = "";
									...
									{
										string text4 = delegate2.Method.Name.TrimStart(new char[]
										{
											'<'
										});
					...
					string str;
					if (!dictionary.TryGetValue(obj, out str))
					{
		...
		foreach (object obj2 in dictionary.Keys)
		{
			if (obj2 != null)
			{
				...
				string str2;
				if (dictionary.TryGetValue(obj2, out str2))
				{
					text5 += str2;
				}
			}
